...
\documentclass[a4paper, 12pt]{$documentclass$}
...
\setlength{\cftsecnumwidth}{0pt} % remove numbering
...
\textbf{ISBN: $isbn$} \\
For any enquiries regarding this publication, contact us at: $email$ or www.education.gov.uk/contactus \\
